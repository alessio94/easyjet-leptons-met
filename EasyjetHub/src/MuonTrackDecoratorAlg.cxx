...
StatusCode MuonTrackDecoratorAlg ::initialize() {
  ...
  ATH_CHECK(m_idtrackPtDecorKey.initialize());
  ATH_CHECK(m_idtrackEtaDecorKey.initialize());
  ATH_CHECK(m_idtrackPhiDecorKey.initialize());
  ATH_CHECK(m_idtrackD0DecorKey.initialize());
  ATH_CHECK(m_idtrackZ0DecorKey.initialize());
  ATH_CHECK(m_idtrackChi2OverDoFDecorKey.initialize());
  ...
  ATH_CHECK(m_idtrackNumIBLHitsDecorKey.initialize());
  ATH_CHECK(m_idtrackNumPixelHitsDecorKey.initialize());
  ATH_CHECK(m_idtrackNumPixelSharedHitsDecorKey.initialize());
  ATH_CHECK(m_idtrackNumSCTHitsDecorKey.initialize());
  ATH_CHECK(m_idtrackNumSCTSharedHitsDecorKey.initialize());
  ...
  ATH_CHECK(m_idtrackNumNextToIBLHitsDecorKey.initialize(m_doLLP1));
  ATH_CHECK(m_idtrackNumPixelSplitHitsDecorKey.initialize(m_doLLP1));
  ATH_CHECK(
      m_idtrackNumTRTHitsDecorKey.initialize(m_doLLP1));
  ...
  ATH_CHECK(m_cbtrackD0DecorKey.initialize());
  ATH_CHECK(m_cbtrackZ0DecorKey.initialize());
  ATH_CHECK(m_cbtrackChi2OverDoFDecorKey.initialize());
...
StatusCode MuonTrackDecoratorAlg ::execute(const EventContext &ctx) const {
  ...
  SG::WriteDecorHandle<xAOD::MuonContainer, float>
    idtrackPtDecorHandle(m_idtrackPtDecorKey);
  SG::WriteDecorHandle<xAOD::MuonContainer, float>
    idtrackEtaDecorHandle(m_idtrackEtaDecorKey);
  SG::WriteDecorHandle<xAOD::MuonContainer, float>
    idtrackPhiDecorHandle(m_idtrackPhiDecorKey);
  SG::WriteDecorHandle<xAOD::MuonContainer, float>
    idtrackD0DecorHandle(m_idtrackD0DecorKey);
  SG::WriteDecorHandle<xAOD::MuonContainer, float>
    idtrackZ0DecorHandle (m_idtrackZ0DecorKey);
  SG::WriteDecorHandle<xAOD::MuonContainer, float>
    idtrackChi2OverDoFDecorHandle(m_idtrackChi2OverDoFDecorKey);
  SG::WriteDecorHandle<xAOD::MuonContainer, float>
    cbtrackD0DecorHandle(m_cbtrackD0DecorKey);
  SG::WriteDecorHandle<xAOD::MuonContainer, float>
    cbtrackZ0DecorHandle(m_cbtrackZ0DecorKey);
  SG::WriteDecorHandle<xAOD::MuonContainer, float>
  ...
  SG::WriteDecorHandle<xAOD::MuonContainer, float>
    idtrackNumPixelSharedHitsDecorHandle(m_idtrackNumPixelSharedHitsDecorKey);
  SG::WriteDecorHandle<xAOD::MuonContainer, float>
  ...
  for (const xAOD::Muon *muon : *muonsIn) {
	...
	? muonIDTrackParticle->chiSquared() / muonIDTrackParticle->numberDoF()
	: -999;
	...
	? muonCBTrackParticle->chiSquared() / muonCBTrackParticle->numberDoF()
	: -999;
    } else {
