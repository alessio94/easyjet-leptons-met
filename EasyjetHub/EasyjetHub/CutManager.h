...
struct CutEntry
{
    ...
    double w_counter{0.0}; //Counts the events passed by the cut in terms of event weights
    ...
    double w_relativeCounter{0.0}; // Counts the events passed with respect to the previous cuts in terms of event weights
