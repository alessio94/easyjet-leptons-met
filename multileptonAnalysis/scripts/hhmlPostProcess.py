...
def RunEasyjetPlus(args):
    ...
    TotalWeightsTool_hhml = CompFactory.TotalWeightsTool(
        analysis="hhml", nLeptons=2, bTagWP=args.bTagWP)
    ...
    acc.addEventAlgo(CompFactory.PostProcessor(
        ...
        postProcessTools=[SOWTool, XSectionTool, TotalWeightsTool_hhml]
    ))
