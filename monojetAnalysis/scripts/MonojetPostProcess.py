...
def RunEasyjetPlus(args):
    ...
    TotalWeightsTool_Monojet = CompFactory.TotalWeightsTool(
        analysis="monojet", bTagWP="GN2v01_FixedCutBEff_85")
    ...
    acc.addEventAlgo(CompFactory.PostProcessor(
        ...
        postProcessTools=[SOWTool, XSectionTool, TotalWeightsTool_Monojet]
    ))
