...
namespace HH4B
{
  LargeUFOJetGhostVRJetAssociationAlg ::LargeUFOJetGhostVRJetAssociationAlg(
  ...
  StatusCode LargeUFOJetGhostVRJetAssociationAlg ::initialize()
  {
    ...
    ATH_CHECK(m_largeUFOJetInKey.initialize());
    ATH_CHECK(m_eventInfoKey.initialize());

    return StatusCode::SUCCESS;
  }

  StatusCode LargeUFOJetGhostVRJetAssociationAlg ::execute()
  {
    ATH_MSG_DEBUG("Executing " << name());

    SG::ReadHandle<xAOD::JetContainer> largeRUFOJets(m_largeUFOJetInKey);
    ATH_CHECK(largeRUFOJets.isValid());
      ...
      const xAOD::JetContainer &largeRUFOJets) const
  {
    ...
    for (auto *largejet : largeRUFOJets)
    {
