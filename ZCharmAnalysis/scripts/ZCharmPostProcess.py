...
def RunEasyjetPlus(args):
    ...
    TotalWeightsTool_ZCharm = CompFactory.TotalWeightsTool(
        analysis="ZCharm", nLeptons=2, bTagWP="GN2v01_FixedCutBEff_85")
    ...
    acc.addEventAlgo(CompFactory.PostProcessor(
        ...
        postProcessTools=[SOWTool, XSectionTool, TotalWeightsTool_ZCharm]
    ))
