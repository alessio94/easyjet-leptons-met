...
#Diboson
easyjet-gridsubmit --mc-list ../easyjet/ZCharmAnalysis/datasets/PHYS/Diboson_Run2_p6266.txtt \
    --run-config ${runConfig} \
    --exec ${executable} \
    --nGBperJob 5 \
    --campaign ${campaignName} \
...
#ttbar+single-top
easyjet-gridsubmit --mc-list ../easyjet/ZCharmAnalysis/datasets/PHYS/Top_Run2_p6266.txt \
    --run-config ${runConfig} \
    --exec ${executable} \
    --nGBperJob 5 \
    --campaign ${campaignName} \
