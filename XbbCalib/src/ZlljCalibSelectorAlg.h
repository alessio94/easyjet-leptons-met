...
#ifndef SELECTIONFLAGSZlljCaLIBALG_H
#define SELECTIONFLAGSZlljCaLIBALG_H
...
namespace XBBCALIB
{
  ...
  class ZlljCalibSelectorAlg final : public AthHistogramAlgorithm {

    public:
      ZlljCalibSelectorAlg(const std::string &name, ISvcLocator *pSvcLocator);
...
#endif // SELECTIONFLAGSZlljCaLIBALG_H
