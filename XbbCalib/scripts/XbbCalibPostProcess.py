...
def RunEasyjetPlus(args):
    ...
    TotalWeightsTool_Xbb = CompFactory.TotalWeightsTool(
        analysis="XbbCalib", nLeptons=1, bTagWP=args.bTagWP)
    ...
    acc.addEventAlgo(CompFactory.PostProcessor(
        ...
        postProcessTools=[SOWTool, XSectionTool, TotalWeightsTool_Xbb]
    ))
...
parser.add_argument("--bTagWP", default="GN2v01_FixedCutBEff_77", type=str,
