...
def RunEasyjetPlus(args):
    ...
    TotalWeightsTool_ZQG = CompFactory.TotalWeightsTool(
        analysis="ZQG", nLeptons=2, bTagWP="GN2v01_FixedCutBEff_85")
    ...
    acc.addEventAlgo(CompFactory.PostProcessor(
        ...
        postProcessTools=[SOWTool, XSectionTool, TotalWeightsTool_ZQG]
    ))
