...
namespace ttHH
{
  ...
  StatusCode ttHHSelectorAlg::initialize()
  {
    ...
    ATH_CHECK(m_tight_selected_el.initialize(m_systematicsList, m_electronHandle));
    ATH_CHECK(m_tight_selected_mu.initialize(m_systematicsList, m_muonHandle));
  ...
  void ttHHSelectorAlg::evaluateTriggerMatchingCuts(const std::vector<std::string> &m_leptonTriggers, 
    ...
    ttHHCuts("PASS_TRIGGER_MATCHING").passed = pass_matching_trigger_singlep;
