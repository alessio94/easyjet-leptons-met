...
#ifndef YYMLANALYSIS_FINALVARSYYMLALG
#define YYMLANALYSIS_FINALVARSYYMLALG
...
namespace HHYYML
{
    ...
    class BaselineVarsyymlAlg final : public AthHistogramAlgorithm
    {
      /// \brief The standard constructor
    public:
        BaselineVarsyymlAlg(const std::string &name, ISvcLocator *pSvcLocator);
    ...
    private:
      ...
      CP::SysReadHandle<xAOD::JetContainer>
          m_jetHandle{ this, "jets", "yymlAnalysisJets_%SYS%", "Jet container to read" };

      CP::SysReadHandle<xAOD::ElectronContainer>
          m_electronHandle{ this, "electrons", "yymlAnalysisElectrons_%SYS%", "Electron container to read" };

      CP::SysReadHandle<xAOD::MuonContainer>
          m_muonHandle{ this, "muons", "yymlAnalysisMuons_%SYS%", "Muon container to read" };

      CP::SysReadHandle<xAOD::TauJetContainer>
          m_tauHandle{ this, "taus", "yymlAnalysisTaus_%SYS%", "Tau container to read" };
