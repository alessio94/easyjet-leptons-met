...
namespace HHYYML
{
  BaselineVarsyymlAlg::BaselineVarsyymlAlg(const std::string &name,
  ...
  StatusCode BaselineVarsyymlAlg::initialize()
  {
    ATH_MSG_INFO("*********************************\n");
    ATH_MSG_INFO("   BaselineVarsyymlAlg           \n");
    ATH_MSG_INFO("*********************************\n");
  ...
  StatusCode BaselineVarsyymlAlg::execute()
  {
