...
def RunEasyjetPlus(args):
    ...
    TotalWeightsTool_llyy = CompFactory.TotalWeightsTool(
        analysis="llyy", nLeptons=2, nPhotons=2, bTagWP=args.bTagWP)
    ...
    acc.addEventAlgo(CompFactory.PostProcessor(
        ...
        postProcessTools=[SOWTool, XSectionTool, TotalWeightsTool_llyy]
    ))
